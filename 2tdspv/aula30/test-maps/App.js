...
export default function App() {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      onPress={()=>{
        const obj = lista[0];
        mapaRef.current.animateToRegion({ // Takes a region object as parameter
      ...
      <MapView ref={mapaRef} style={{flex: 1}} initialRegion={{
        latitude: -23.564316580274077, 
        longitude: -46.652427518019735,
      ...
      >
        ...
        {lista.map( (item) => <Marker coordinate={{
