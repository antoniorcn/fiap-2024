...
public class G extends JPanel implements Runnable
{
    private boolean[] k = new boolean[32767];
    private int m;
    private BufferedImage currentImage = new BufferedImage(800, 600, BufferedImage.TYPE_INT_RGB);
    ...
    public static void main(String args[]) { 
        G g = new G();
        JFrame janela = new JFrame("Left 4 Death");
        janela.getContentPane().add( g );
        g.start();
...
//                        dir = d * Math.PI * 2 / 64;
        ...
        restart: while (true)
        {
            ...
            winLevel: while (true)
            {
                ...
                Graphics sg = currentImage.getGraphics();
                random = new Random();
                while (true)
                {
                    if (gameStarted)
