...
const api = axios.create({
  baseURL: "https://95abde56-028d-4c19-9cae-fd4c00cf54d9-00-1lji1cvl1zomi.riker.replit.dev"
})
...
export default function App() {
  ...
  const logar = ( user, password ) => {
    ...
    .then((resposta)=>{
      ToastAndroid.show("Dados: " + JSON.stringify(resposta.data), ToastAndroid.LONG);
